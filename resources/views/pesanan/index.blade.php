...
<div class="flex-1 bg-gray-50 text-gray-800 font-sans">
    <div class="w-full px-4 md:px-6 py-6 space-y-5">
        ...
        <div class="flex items-center justify-between gap-3">
            <div>
                <h1 class="text-lg font-bold text-gray-900">Daftar Pesanan Resto</h1>
                <p class="text-xs text-gray-500 mt-0.5">Kelola transaksi pesanan dine-in, rincian menu, status dapur, dan pembayaran</p>
            </div>
