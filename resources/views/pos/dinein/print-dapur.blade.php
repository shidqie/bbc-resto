...
<head>
    ...
    <title>Checker Dapur - {{ $pesanan->kode_pesanan }}</title>
    <style>
...
<body>
    ...
    <div class="text-center font-bold" style="font-size: 11px; margin-top: 6px;">
        === MOHON DIPROSES DAPUR ===
    </div>

    <div class="no-print" style="margin-top: 15px; text-align: center;">
        <button onclick="window.print()" style="padding: 6px 14px; font-size: 12px; font-weight: bold; cursor: pointer;">Cetak Struk Dapur</button>
    </div>
