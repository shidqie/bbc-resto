...
<div class="h-[calc(100vh-65px)] flex items-center justify-center bg-[#f5f5f0] text-[#111827] font-sans">
    ...
    <div class="w-full p-6 bg-white rounded-xl w-full shadow-lg border border-gray-100 flex flex-col items-center text-center space-y-6 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center">
            ...
            <p class="text-sm font-medium text-gray-500 mt-2">
                Pesanan <span class="font-bold text-[#0D3024]">#{{ $pesanan->nomor_pesanan ?? 'DIN-'.$pesanan->id }}</span> telah berhasil dibayar.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <div x-data="{ showSavePrintModal: false }">
                    ...
                    <div x-show="showSavePrintModal" x-transition.opacity class="fixed inset-0 bg-slate-900/60 backdrop-blur-xs z-50 flex items-center justify-center p-4 text-left" style="display: none;">
                        <div class="bg-white rounded-xl p-6 max-w-lg w-full shadow-2xl border border-gray-100 relative" @click.outside="showSavePrintModal = false">
                            
                            {{-- Modal Header --}}
                            <div class="text-center mb-6 relative">
                                <h3 class="text-lg font-bold text-gray-800">Cetak Struk</h3>
                                <p class="text-sm font-medium text-gray-500 mt-1">Pilih struk yang akan dicetak</p>
                            ...
                            <div class="space-y-3">
                                ...
                                <button type="button" onclick="printSilentIframe('/pos/dinein/pesanan/{{ $pesanan->id }}/print-nota')" class="w-full group bg-white border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 rounded-xl p-4 flex items-center justify-between transition-all cursor-pointer">
                                ...
                                <button type="button" onclick="printSilentIframe('/pos/dinein/pesanan/{{ $pesanan->id }}/print-dapur')" class="w-full group bg-white border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 rounded-xl p-4 flex items-center justify-between transition-all cursor-pointer">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-full bg-gray-50 group-hover:bg-white flex items-center justify-center text-gray-500 group-hover:text-emerald-600 shadow-sm border border-gray-100 transition-colors">
                                ...
                                <button type="button" onclick="printSilentIframe('/pos/dinein/pesanan/{{ $pesanan->id }}/print-meja')" class="w-full group bg-white border border-gray-100 hover:border-emerald-200 hover:bg-emerald-50/30 rounded-xl p-4 flex items-center justify-between transition-all cursor-pointer">
                                    <div class="flex items-center gap-3">
                                         <div class="w-10 h-10 rounded-full bg-gray-50 group-hover:bg-white flex items-center justify-center text-gray-500 group-hover:text-emerald-600 shadow-sm border border-gray-100 transition-colors">
