...
<div class="flex-1 overflow-auto bg-gray-50/50 text-gray-800 font-sans">
    <div class="p-4 md:p-6 lg:p-8 max-w-[1000px] mx-auto space-y-6">
        ...
        <x-ui.page-header 
            ...
            <x-slot:actions>
                <x-ui.button href="{{ route('menu.show', $menu->id) }}" variant="outline" icon="fa-arrow-left">Kembali</x-ui.button>
            </x-slot:actions>
        </x-ui.page-header>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <form action="{{ route('resep.store', $menu->id) }}" method="POST" class="p-6">
                ...
                <div class="flex justify-end gap-3 pt-6 mt-6 border-t border-gray-100">
                    ...
                    <x-ui.button type="submit" icon="fa-save">Simpan Resep</x-ui.button>
                </div>
            </form>
        </div>
    </div>
