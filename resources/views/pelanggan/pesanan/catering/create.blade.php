<x-layouts.landing>
    ...
    @php
        ...
        $summaryConfig = [
            ...
            'satuanLabel' => 'Porsi',
            'dpPersen'    => 50,
            'batasTeks'   => 'Pelunasan wajib dilakukan paling lambat H-4 sebelum tanggal pengambilan atau pengiriman pesanan.',
            'syarat'      => [
                ...
                'Apabila hingga batas waktu H-4 konsumen belum melakukan pelunasan, maka pesanan dianggap batal.',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-surface border border-primary/10 rounded-2xl shadow-sm p-5 sm:p-7 mb-6">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <a href="{{ url('/') }}"
                       onclick="return confirm('Batalkan pemesanan? Data yang sudah diisi akan hilang.')"
                       class="inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl border border-primary/10 text-body text-sm font-medium hover:bg-primary/5 hover:text-primary transition-colors self-start shrink-0">
                    ...
                    <div class="relative grid grid-cols-5 gap-1">
                        @foreach([1 => 'Data Pemesan', 2 => 'Detail Acara', 3 => 'Pilih Paket', 4 => 'Pilih Menu', 5 => 'Pembayaran'] as $n => $stepLabel)
                            <div class="step-item flex flex-col items-center gap-1.5" data-step="{{ $n }}">
                                <div class="step-dot w-7 h-7 sm:w-8 sm:h-8 rounded-full border-2 border-primary/20 bg-surface flex items-center justify-center text-xs sm:text-[13px] font-bold text-body/40 transition-all duration-300">
                                    <span class="step-num">{{ $n }}</span>
                                    <i class="ph-bold ph-check step-check hidden"></i>
                                </div>
                                <span class="step-label hidden sm:block text-[11px] font-semibold text-body/50 leading-tight text-center">{{ $stepLabel }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <form id="cateringForm" method="POST" action="{{ route('pesan.catering.store') }}">
                ...
                <div class="grid lg:grid-cols-3 gap-6 items-start">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <section class="bg-surface border border-primary/10 rounded-2xl shadow-sm p-5 sm:p-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4 items-start">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <p class="text-[11px] text-body/50 font-medium mt-1.5 flex items-center gap-1"><i class="ph ph-info"></i> Minimal pemesanan 50 porsi.</p>
                                    ...
                                    <label class="paket-card cursor-pointer border rounded-2xl p-4 transition-all duration-200 hover:border-primary hover:shadow-sm border-primary/10 bg-surface relative flex flex-col"
                                        ...
                                        <div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <span class="text-xs font-bold text-primary">Rp {{ number_format($paket->harga_jual, 0, ',', '.') }} <span class="text-[11px] font-normal text-body/50">/porsi</span></span>
                                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                <label class="flex-1 flex items-center gap-3 border border-primary bg-primary/5 rounded-xl px-4 py-3 cursor-pointer transition-all duration-200">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[11px] text-body/60 font-medium">Sisa dibayar H-4 sebelum acara</p>
                                    </div>
                                </label>
                        ...
                        <button type="submit" class="lg:hidden w-full inline-flex items-center justify-center gap-2 bg-primary text-white font-bold text-sm py-3.5 rounded-xl hover:bg-primary/90 transition-colors">
                            Lanjutkan Pemesanan
