            ...
            <div class="px-5 py-5 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <div class="relative">
                            <select name="jenis_paket" id="fpJenis" required class="w-full appearance-none px-3.5 py-2.5 pr-9 text-sm font-semibold border border-gray-200 rounded-xl bg-white outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-xs cursor-pointer">
