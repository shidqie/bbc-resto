...
<head>
    <meta charset="utf-8">
    <title>Laporan Pendapatan Nasi Box</title>
    <style>
...
<body>
    <div class="header">
        <h1>Laporan Pendapatan Nasi Box</h1>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $p->menu->nama ?? '-' }} ({{ $p->jumlah_box }} Box)</td>
        ...
        <tfoot>
            <tr class="total-row">
                <th colspan="5">TOTAL PENDAPATAN NASI BOX</th>
