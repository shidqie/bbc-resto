    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-6">
        <form action="{{ route('admin.pesanan.index') }}" method="GET" class="flex flex-wrap items-end gap-4">
            <div class="flex-1 min-w-[200px]">
                <label class="block text-sm font-bold text-gray-600 mb-1">Cari Pesanan</label>
            ...
            <div class="w-40">
                <label class="block text-sm font-bold text-gray-600 mb-1">Jenis Pesanan</label>
            ...
            <button type="submit" class="px-5 py-2.5 bg-[#0D3024] hover:bg-[#0a1f17] text-white rounded-xl text-sm font-bold shadow-sm transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50 text-gray-500 font-extrabold uppercase text-sm tracking-wider border-b border-gray-100">
                        <th class="p-4">No.</th>
                ...
                <tbody class="divide-y divide-gray-50 text-sm">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="p-4 font-black text-[#0D3024]">
                        ...
                        <td class="p-4 text-center">
                            ...
                            @endphp
                            <span class="px-2.5 py-1 bg-{{$payColor}}-50 text-{{$payColor}}-700 border border-{{$payColor}}-200 rounded-lg text-xs font-extrabold uppercase whitespace-nowrap">
                                {{ $payStatus }}
                            </span>
                        </td>
                        <td class="p-4 text-center">
                            ...
                            @endphp
                            <span class="px-2.5 py-1 bg-{{$color}}-50 text-{{$color}}-700 border border-{{$color}}-200 rounded-lg text-xs font-extrabold uppercase whitespace-nowrap">
