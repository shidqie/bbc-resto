         ...
         x-data="{
            ...
            updatePesan() {
                ...
                if (this.jenisPengingat === 'pesanan') {
                    this.pesanWa = `Halo ${this.nama}, kami dari RM BBC ingin mengonfirmasi & mengingatkan pesanan ${this.jenis} ${this.paket} sebanyak ${this.porsi} box (Kode Pesanan: #${this.kode}) untuk tanggal ${this.tanggal}${waktuStr}.\n\nStatus Pembayaran: ${this.statusBayar}\n\nUntuk melihat rincian dan melacak status pesanan Anda, silakan kunjungi:\n${linkLacak}\n\nMohon pastikan kembali bahwa rincian pesanan dan jadwal acara sudah sesuai. Terima kasih.`;
                } else if (this.jenisPengingat === 'pembayaran_dp') {
                    if (this.isSkemaLunas) {
                        this.pesanWa = `Halo ${this.nama}, kami dari RM BBC ingin mengingatkan pembayaran untuk pesanan ${this.jenis} ${this.paket} (${this.porsi} box) dengan kode #${this.kode}.\n\nNominal Tagihan: Rp ${this.nominalDp}\n\nSilakan selesaikan pembayaran dan unggah bukti transfer melalui tautan berikut:\n${linkBayar}\n\nLacak status pesanan:\n${linkLacak}\n\nTerima kasih.`;
                    } else {
                        this.pesanWa = `Halo ${this.nama}, kami dari RM BBC ingin mengingatkan pembayaran Uang Muka (DP 25%) untuk pesanan ${this.jenis} ${this.paket} (${this.porsi} box) dengan kode #${this.kode}.\n\nNominal DP: Rp ${this.nominalDp}\n\nSilakan selesaikan pembayaran dan unggah bukti transfer melalui tautan berikut:\n${linkBayar}\n\nLacak status pesanan:\n${linkLacak}\n\nTerima kasih.`;
                    }
