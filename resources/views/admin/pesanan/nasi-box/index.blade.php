                ...
                <x-ui.table class="min-w-[1100px]">
                    ...
                    @forelse($pesanans as $p)
                        <x-ui.table.row>
                            ...
                            <td class="px-4 py-4 align-middle">
                                <p class="font-semibold text-gray-900 text-xs whitespace-nowrap">{{ optional($p->pelanggan)->nama ?? $p->jadwal_pesanan->nama_penerima ?? $p->nama_konsumen ?? 'Nasi Box' }}</p>
                            </td>
                            <td class="px-4 py-4 align-middle whitespace-nowrap">
                                @if($p->jadwal_pesanan?->tanggal_acara)
                            ...
                            <td class="px-4 py-4 text-center">
                                <div class="flex items-center justify-center gap-1.5 flex-wrap">
                                    ...
                                    <x-ui.action-button href="{{ route('admin.pesanan.nasibox.pdf', $p->id) }}" target="_blank" title="Cetak Bukti Pemesanan" label="Bukti">
