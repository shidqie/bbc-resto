...
<div class="flex-1 bg-gray-50 text-gray-800 font-sans">
    <div class="w-full px-4 md:px-6 py-6 space-y-5">
        ...
        <div class="flex items-center justify-between gap-3">
            <div>
                <h1 class="text-lg font-bold text-gray-900">Daftar Pesanan Nasi Box</h1>
                <p class="text-xs text-gray-500 mt-0.5">Kelola transaksi pesanan nasi box, tanggal kirim, rincian box & status pembayaran.</p>
            </div>
        </div>
                    ...
                    @forelse($pesanans as $p)
                        <tr class="hover:bg-gray-50/60 transition-colors group">
                            ...
                            <td class="px-4 py-3 font-semibold text-gray-900 tabular-nums">
                                ...
                                @if($p->dp_amount)
                                    <p class="text-xs text-gray-500 font-normal mt-0.5">DP: <span class="font-semibold text-purple-600">Rp {{ number_format($p->dp_amount, 0, ',', '.') }}</span></p>
                                @endif
                            </td>
                            <td class="px-4 py-3">
                                @php
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                                    <a href="{{ route('admin.pesanan.nasibox.show', $p->id) }}" class="p-1.5 rounded-md text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors" title="Detail Pesanan">
