    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Detail Pesanan Nasi Box') }} #{{ $pesanan->kode_pesanan }}
            </h2>
            <a href="{{ route('admin.pesanan.nasibox.index') }}" class="text-sm text-gray-600 hover:text-gray-900">&larr; Kembali</a>
        </div>
    </x-slot>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="space-y-3 text-sm mb-4">
                            <div class="grid grid-cols-3"><span class="text-gray-500">Varian Nasi Box</span> <span class="col-span-2 font-semibold">{{ $pesanan->menu->nama }}</span></div>
                            <div class="grid grid-cols-3"><span class="text-gray-500">Jumlah Box</span> <span class="col-span-2">{{ $pesanan->jumlah_box }}</span></div>
                            <div class="grid grid-cols-3"><span class="text-gray-500">Harga per Box</span> <span class="col-span-2">Rp {{ number_format($pesanan->menu->harga, 0, ',', '.') }}</span></div>
                        ...
                        <h4 class="font-medium text-gray-700 mb-2">Isi Varian:</h4>
                        <p class="text-sm text-gray-600">{{ $pesanan->menu->deskripsi }}</p>
                    </div>
                </div>
            </div>
