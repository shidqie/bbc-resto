...
<div class="flex-1 bg-gray-50 text-gray-800">
    <div class="w-full p-6 space-y-5">
        ...
        <x-ui.page-header
            title="Stok Katering"
            subtitle="Monitor stok bahan baku khusus untuk pemenuhan pesanan Katering."
                                ...
                                <td class="px-4 py-4">
                                    <div class="space-y-0.5">
                                        <div class="font-bold text-gray-900 text-sm flex items-center gap-2">
                                            ...
                                            @if($group['tipe'])
                                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full border {{ $group['tipe'] === 'Catering' ? 'bg-amber-50 text-amber-700 border-amber-200' : ($group['tipe'] === 'Penyesuaian' ? 'bg-purple-50 text-purple-700 border-purple-200' : 'bg-emerald-50 text-emerald-700 border-emerald-200') }}">
                                                    {{ $group['tipe'] }}
                                                </span>
                                            @endif
                                        </div>
                                        @if($group['pelanggan'])
                                            <p class="text-xs text-gray-500 font-medium">
                                                Pemesan: <span class="text-gray-700 font-semibold">{{ $group['pelanggan'] }}</span>
                                            </p>
                                        @endif
                                    </div>
                                </td>
