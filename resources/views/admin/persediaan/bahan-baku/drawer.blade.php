        ...
        <div class="bg-white border border-slate-200/80 rounded-2xl divide-y divide-slate-100 text-xs shadow-2xs overflow-hidden">
            ...
            <div class="p-3.5 flex items-center justify-between bg-slate-50/70">
                <div>
                    ...
                    <span class="text-[11px] text-slate-400">Resto: {{ \App\Helpers\UnitHelper::formatQuantity($stokHarian, $satuanNama) }} • Katering: {{ \App\Helpers\UnitHelper::formatQuantity($stokCatering, $satuanNama) }}</span>
                </div>
            ...
            <div class="p-3.5 flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <span class="text-[10px] text-slate-400 block font-normal">(Batas Min Harian Resto)</span>
                </div>
            </div>
