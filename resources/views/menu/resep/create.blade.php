...
<div class="flex-1 bg-gray-50 text-gray-800">
    <div class="w-full max-w-4xl mx-auto p-6 space-y-5">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('resep.index') }}" class="w-8 h-8 flex items-center justify-center rounded-lg bg-white border border-gray-200 text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            <form action="{{ route('resep.store', $menu->id) }}" method="POST">
                ...
                <div class="mb-5 flex justify-between items-end">
                    ...
                    <button type="button" onclick="addBahanBakuRow()" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">
                ...
                <div class="space-y-3" id="bahanBakuContainer">
                    @forelse($menu->resep_menu as $resep)
                        <div class="flex gap-3 items-start bahan-baku-row">
                            ...
                            <div class="pt-6">
                                <button type="button" onclick="this.closest('.bahan-baku-row').remove(); calculateHPP()" class="w-9 h-9 flex items-center justify-center rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors">
