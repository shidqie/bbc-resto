...
<body class="bg-[#F8FAFC] min-h-screen flex items-center justify-center p-5">
    <div class="max-w-sm w-full text-center">
        {{-- Logo --}}
        <div class="w-16 h-16 rounded-full bg-[#0F2E23] flex items-center justify-center mx-auto mb-6 shadow-xl shadow-[#0F2E23]/20">
            <x-heroicon-o-sparkles class="w-7 h-7 text-emerald-300" />
        </div>

        {{-- Ilustrasi QR --}}
        <div class="w-32 h-32 rounded-[2.25rem] bg-white border-2 border-dashed border-gray-200 flex items-center justify-center mx-auto mb-6 shadow-sm">
        ...
        <div class="bg-white border border-gray-200 rounded-[2.25rem] p-4 text-left space-y-3 shadow-sm mb-6">
