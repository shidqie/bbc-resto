...
<div class="flex-1 bg-gray-50 text-gray-800 font-sans">
    <div class="w-full px-4 md:px-6 py-6 space-y-5">
        ...
        <div class="flex items-center justify-between gap-3">
            <div>
                <h1 class="text-lg font-bold text-gray-900">Laporan Menu Terlaris</h1>
                <p class="text-xs text-gray-500 mt-0.5">Analisis menu dengan penjualan tertinggi pada periode yang dipilih</p>
            </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr>
                        <td colspan="6" class="py-14 text-center text-gray-400">
                            <i class="fa-solid fa-chart-bar text-4xl mb-3 text-gray-300 block"></i>
