    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-6 py-20 w-full">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="{{ route('pesan.catering') }}" class="bg-primary text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-primary-container transition-all shadow-sm">Pesan Sekarang</a>
            </div>
        </div>
    </div>
</section>
