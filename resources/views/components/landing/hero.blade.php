<section id="beranda" class="relative flex items-center overflow-hidden" style="min-height: calc(100vh - 80px);">
    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-6 py-20 w-full">
        <div class="max-w-3xl">
            <x-typography.h1 class="!text-white md:!text-5xl lg:!text-6xl drop-shadow-lg mb-6">Saung Babakan Cinta</x-typography.h1>
            ...
            <div class="flex flex-wrap gap-4">
                <a href="{{ route('pesan.catering') }}" class="bg-primary text-white px-5 py-2.5 rounded-md font-bold text-sm hover:bg-primary-container transition-all shadow-sm">Pesan Sekarang</a>
            </div>
        </div>
    </div>
</section>
