    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-6 py-20 w-full">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="{{ route('pesan.catering') }}" class="inline-flex items-center justify-center px-8 py-3 rounded-full bg-white text-neutral-900 font-medium text-sm hover:bg-neutral-100 transition-all duration-300">Pesan Sekarang</a>
                <a href="#menu-dinein" class="inline-flex items-center justify-center px-8 py-3 rounded-full border border-white/30 text-white font-medium text-sm hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">Lihat Menu</a>
            </div>
        </div>
    </div>
</section>
