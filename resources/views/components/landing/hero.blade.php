<section id="beranda" class="relative flex items-center overflow-hidden min-h-[85vh] lg:min-h-[calc(100vh-80px)]">
    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-6 py-16 w-full">
        <div class="max-w-3xl">
            ...
            <x-typography.p variant="large" class="!text-white/80 mb-8 max-w-xl font-light text-sm md:text-base">Hidangan Sunda otentik dalam suasana saung yang nyaman. Makan di tempat, catering, dan nasi box.</x-typography.p>
            <div class="flex flex-wrap gap-3">
                <a href="{{ route('pesan.catering') }}" class="inline-flex items-center justify-center px-5 py-2 rounded-full bg-white/90 text-neutral-900 font-medium text-xs hover:bg-white transition-all duration-300 shadow-sm">Pesan Sekarang</a>
