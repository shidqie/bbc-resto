    ...
    <div class="relative z-10 max-w-[1280px] mx-auto px-6 py-16 w-full">
        <div class="max-w-3xl">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="#catering" class="inline-flex items-center justify-center px-5 py-2 rounded-full bg-white/90 text-black font-medium text-xs hover:bg-white transition-all duration-300 shadow-sm">Pesan Sekarang</a>
