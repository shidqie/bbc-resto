...
<div class="relative {{ $width }} shrink-0">
    <select
        ...
        {{ $attributes->merge(['class' => 'w-full appearance-none rounded-lg border border-gray-200 bg-white py-2 pl-3 pr-9 text-sm text-gray-900 shadow-sm outline-none transition-all focus:border-gray-400 focus:ring-1 focus:ring-gray-400']) }}
    >
