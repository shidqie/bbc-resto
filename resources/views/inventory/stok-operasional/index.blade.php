...
<div class="flex-1 bg-gray-50 text-gray-800">
    <div class="w-full p-6 space-y-5">
        ...
        <x-ui.page-header
            ...
            subtitle="Monitor stok bahan baku untuk kebutuhan harian (dine-in, restoran, nasi box)."
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <x-ui.stat-card label="Total Bahan" :value="$stats['total_bahan']" icon="cube" color="blue" />
